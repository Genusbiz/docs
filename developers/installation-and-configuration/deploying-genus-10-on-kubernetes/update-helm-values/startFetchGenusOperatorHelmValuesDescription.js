...
async function startFetchGenusOperatorHelmValuesDescription(api) {
	...
	await fetchHelmValueDescriptionFromGitlab('develop', '7.1')
	await fetchHelmValueDescriptionFromGitlab('release/7.0', '7.0')
	await fetchHelmValueDescriptionFromGitlab('release/6.3', '6.3')
