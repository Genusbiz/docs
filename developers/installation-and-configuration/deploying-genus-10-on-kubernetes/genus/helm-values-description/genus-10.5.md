...
| <microservice>.resources.requests.cpu                            |  | *See [values.yaml](../genus/default-helm-values/genus-10.5.md)* |
| <microservice>.resources.requests.memory                         |  | *See [values.yaml](../genus/default-helm-values/genus-10.5.md)* |
| <microservice>.resources.limits.cpu                              |  | *See [values.yaml](../genus/default-helm-values/genus-10.5.md)* |
| <microservice>.resources.limits.memory                           |  | *See [values.yaml](../genus/default-helm-values/genus-10.5.md)* |
| <microservice>.affinityScheduling.enabled                        |  | *See [values.yaml](../genus/default-helm-values/genus-10.5.md)* |
| <microservice>.affinityScheduling.namespaceListForPodAntiAffinity|  | *See [values.yaml](../genus/default-helm-values/genus-10.5.md)* |
