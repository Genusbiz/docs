...
| **Default Language** | The default language for the application model. For more information, see [Translate the Application Model to Other Languages](../../../defining-an-app-model/translate-the-application-model-to-other-languages.md). |
