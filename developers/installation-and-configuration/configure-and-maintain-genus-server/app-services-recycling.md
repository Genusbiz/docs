 ...
 **The Core Service is been fully integrated into the Internet Information Services (IIS) Application Pool used by the Genus Services Web Site.  
...
2.  In the Start menu, type "genus" and then click **Genus Services Management Console**.
...
5.  In the list of application pools, select **Genus Services Web Site**.
