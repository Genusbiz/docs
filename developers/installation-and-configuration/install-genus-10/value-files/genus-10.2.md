...
| <microservice>.resources.requests.cpu                            |  | *See [values.yaml](./genus-values/genus-10.2.yaml)* |
| <microservice>.resources.requests.memory                         |  | *See [values.yaml](./genus-values/genus-10.2.yaml)* |
| <microservice>.resources.limits.cpu                              |  | *See [values.yaml](./genus-values/genus-10.2.yaml)* |
| <microservice>.resources.limits.memory                           |  | *See [values.yaml](./genus-values/genus-10.2.yaml)* |
