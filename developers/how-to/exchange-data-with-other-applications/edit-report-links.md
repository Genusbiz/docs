...
*   Entries in the Task Pane for [forms](../../defining-an-app-model/object-class/modify-an-object--or-identifier-domain/explore.md) and [tables](../../defining-an-app-model/user-interface/tables/events.md).
