...
*   Entries in the Task Pane for [forms](../../defining-the-app-model/data/object-class/modify-an-object-or-identifier-domain/explore.md) and [tables](../../defining-the-app-model/user-interface/tables/events.md).
*   [Shortcuts in the Navigation Pane](../../defining-the-app-model/user-interface/navigation-pane.md).
