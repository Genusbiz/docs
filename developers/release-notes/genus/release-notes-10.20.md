...
- Start Monitor Geolocation Position (_Retrieve Once, Retrieve Each Time the Position of the Device Changes_)
...
_<an-object>.defaultWebPageLink(appPathSegment:string) : URL_

<!--ID 1bb0fd88-61d3-4132-abb7-6d1cfeb9449a -->

**#23555 Renamed desktop effect "Merge Documents" to "Combine Documents"**

Based on terminology used by Adobe. Renamed to avoid confusion with _Merge Data to a Document_ effect.
