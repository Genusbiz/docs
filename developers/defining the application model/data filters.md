...
*   [Create a Data Filter](#create-a-data-filter)
...
9.  If you have selected **Select a specific set of objects** as <span style="FONT-WEIGHT: normal">Method, in the **Filter** tab click **Add** to add specific objects. Standard search is used to find objects.
