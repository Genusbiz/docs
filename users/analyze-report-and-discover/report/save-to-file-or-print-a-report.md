...
A report can also be saved to file as a step in a [task](../../../developers/defining-an-app-model/tasks.md), [agent](../../../developers/defining-an-app-model/agents.md), [web service](../../../developers/defining-an-app-model/web-services.md) or [rule](../../../developers/defining-an-app-model/object-class/modify-an-object--or-identifier-domain/rules.md).  
