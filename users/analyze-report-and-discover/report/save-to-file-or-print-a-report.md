...
A report can also be saved to file as a step in a [task](../../../developers/defining-an-app-model/logic/tasks.md), [agent](../../../developers/defining-an-app-model/logic/agents.md), [web service](../../../developers/defining-an-app-model/services/web-services/index.md) or [rule](../../../developers/defining-an-app-model/data/object-class/modify-an-object-or-identifier-domain/rules.md).  
