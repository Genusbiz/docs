...
## Circle packing
A *circle packing* is a layout of circles, where the size of a circle correspond to a [Value](../concepts/index.md). 
...
## Combination chart
A *combination chart* visualizes more than one [Value](../concepts/index.md) grouped by a single [Category](../concepts/index.md)
...
## Dropdown
A *dropdown* visualizes multiple [Categories](../concepts/category.md). It supports n categories, and shows a dropdown for each, containing the objects from the category data source.
